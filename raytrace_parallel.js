(function() {
    ...
    */
    ...
    __exports.__wbg_setTimeout_17b2c2d82a106638 = function(arg0) {
...
__exports.__wbindgen_closure_wrapper137 = function(a, b, fi, di, _ignored) {
...
__exports.__wbindgen_closure_wrapper139 = function(a, b, fi, di, _ignored) {
    const f = wasm.__wbg_function_table.get(fi);
    const d = wasm.__wbg_function_table.get(di);
    const cb = function(arg0) {
        this.cnt++;
...
__exports.__wbindgen_closure_wrapper174 = function(a, b, fi, di, _ignored) {
    const f = wasm.__wbg_function_table.get(fi);
    const d = wasm.__wbg_function_table.get(di);
    const cb = function() {
        this.cnt++;
